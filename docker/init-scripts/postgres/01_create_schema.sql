...
-- Table des sites hydrométriques
...
-- Table des observations hydrométriques
CREATE TABLE IF NOT EXISTS hubeau.hydrometry_observations (
    ...
    -- Contrainte d'unicité
    UNIQUE(code_station, date_obs, grandeur),
    -- Métadonnées
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
-- Table des stations de qualité des rivières
...
-- Table des analyses qualité rivières
...
-- Table des stations de qualité des eaux souterraines
...
-- Table des analyses qualité eaux souterraines
