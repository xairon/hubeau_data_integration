...
HUBEAU_FIELD_TYPES: Dict[str, Dict[str, str]] = {
    ...
    "hydrometry_stations": {
        ...
        "descriptif_station": "DOUBLE PRECISION",
        "en_service": "BOOLEAN",
...
TABLE_PK_MAPPING: Dict[str, List[str]] = {
    ...
    "piezometry_chroniques": ["code_bss", "timestamp_mesure"],
    "quality_groundwater_stations": ["bss_id"],
    "quality_groundwater_analyses": ["bss_id", "date_debut_prelevement", "code_param"],
...
TABLE_FK_MAPPING: Dict[str, List[Tuple[str, str, str]]] = {
    ...
    "quality_groundwater_analyses": [("bss_id", "quality_groundwater_stations", "bss_id")],
