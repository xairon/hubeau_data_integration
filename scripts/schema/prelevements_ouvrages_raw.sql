-- Table: prelevements_ouvrages_raw (Bronze Layer)
...
CREATE TABLE IF NOT EXISTS hubeau.prelevements_ouvrages_raw (
    code_bdlisa TEXT,
...
CREATE INDEX IF NOT EXISTS idx_prelevements_ouvrages_raw_code_ouvrage
ON hubeau.prelevements_ouvrages_raw(code_ouvrage);

-- Index for date updates
CREATE INDEX IF NOT EXISTS idx_prelevements_ouvrages_raw_date_exploitation_debut
ON hubeau.prelevements_ouvrages_raw(date_exploitation_debut);

COMMENT ON TABLE hubeau.prelevements_ouvrages_raw IS
