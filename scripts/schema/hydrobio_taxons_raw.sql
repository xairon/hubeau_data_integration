-- Table: hydrobio_taxons_raw (Bronze Layer)
...
CREATE TABLE IF NOT EXISTS hubeau.hydrobio_taxons_raw (
...
CREATE INDEX IF NOT EXISTS idx_hydrobio_taxons_raw_date_prelevement
ON hubeau.hydrobio_taxons_raw(date_prelevement);

-- Index for station-based queries
CREATE INDEX IF NOT EXISTS idx_hydrobio_taxons_raw_code_station_hydrobio
ON hubeau.hydrobio_taxons_raw(code_station_hydrobio);

COMMENT ON TABLE hubeau.hydrobio_taxons_raw IS
